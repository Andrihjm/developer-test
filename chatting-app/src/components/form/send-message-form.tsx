...
import { useSendMessageUserMutation } from "../../redux/api/message-api-slice";
...
const SendRoomForm = () => {
  ...
  const [sendMessageInRoom, { isLoading }] = useSendMessageUserMutation();
  ...
  const isDisabled = !userId || isLoading || message.trim() === "";
